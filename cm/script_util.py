...
from .unet_noise import UNetNoiseModel
import numpy as np
...
def create_noisemodel(
    ...
    if checkpoint:
        ckpt = torch.load(checkpoint, map_location = lambda storage, loc: storage.cuda(torch.cuda.current_device()))
