...
## Stage 1 MultiCoil
mpiexec -n 1 python -m scripts.cm_train_stage1 --train_root /raid/kaifengpang/M4Raw/multicoil_train --val_root /raid/kaifengpang/M4Raw/multicoil_val 
--sequence T1 --total_training_steps 150000 --lr_anneal_steps 0 --attention_resolutions 16 --use_scale_shift_norm False --dropout 0.0 --global_batch_size 4
 --image_size 256 --lr 0.000005 --in_channels 4 --out_channels 1 --num_channels 32 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True 
 --use_fp16 True --weight_decay 0.0 --save_dir ./save/train_m4raw_stage1 --save_interval 10000 --epoch 25 --log_interval 200 --channel_mult 1,2,4,8,8

## Stage 2 MultiCoil

mpiexec -n 1 python -m scripts.cm_train_stage2 --train_root /raid/kaifengpang/M4Raw/multicoil_train --val_root /raid/kaifengpang/M4Raw/multicoil_val 
--sequence T1 --training_mode consistency_training --target_ema_mode adaptive --start_ema 0.95 --scale_mode progressive --start_scales 2 
--end_scales 150 --total_training_steps 300000 --loss_norm lpips --lr_anneal_steps 0 --attention_resolutions 16 --use_scale_shift_norm False 
--dropout 0.0 --teacher_dropout 0.1 --ema_rate 0.9999,0.99994,0.9999432189950708 --global_batch_size 2 --image_size 256 --lr 0.00005 --noisy_in_channels 4
--in_channels 1 --out_channels 1 --num_channels 32 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --schedule_sampler uniform --use_fp16 True
--weight_decay 0.0 --weight_schedule uniform --save_dir ./save/debug_new --save_interval 10000 --epoch 24 --channel_mult 1,2,4,8,8 --sigma_min 0.002 
--sigma_max 10 --noisemodel_checkpoint /raid/kaifengpang/CM_denoising/save/train_m4raw_stage1/model170000.pt 



## Stage 1 DWI

mpiexec -n 1 python -m scripts.cm_train_stage1_dwi --data_root /raid/kaifengpang/CM_denoising/dwi_data/HARDI150.nii.gz --total_training_steps 150000
--lr_anneal_steps 0 --attention_resolutions 16 --use_scale_shift_norm False --dropout 0.0 --global_batch_size 4 --image_size 128 --lr 0.000005
--in_channels 2 --out_channels 1 --num_channels 32 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --use_fp16 True --weight_decay 0.0
--save_dir ./save/train_hardi_stage1 --save_interval 10000 --epoch 53 --log_interval 500 --channel_mult 1,2,4,8,8 


## Stage 2 DWI

mpiexec -n 1 python -m scripts.cm_train_stage2_dwi --data_root /raid/kaifengpang/CM_denoising/dwi_data/HARDI150.nii.gz
--training_mode consistency_training --target_ema_mode adaptive --start_ema 0.95 --scale_mode progressive --start_scales 2 
--end_scales 150 --total_training_steps 300000 --loss_norm lpips --lr_anneal_steps 0 --attention_resolutions 16 --use_scale_shift_norm False 
--dropout 0.0 --teacher_dropout 0.1 --ema_rate 0.9999,0.99994,0.9999432189950708 --global_batch_size 2 --image_size 128 --lr 0.00005 --noisy_in_channels 2
--in_channels 1 --out_channels 1 --num_channels 32 --num_head_channels 32 --num_res_blocks 2 --resblock_updown True --schedule_sampler uniform --use_fp16 True
--weight_decay 0.0 --weight_schedule uniform --save_dir ./save/train_hardi_stage2 --save_interval 10000 --epoch 53 --channel_mult 1,2,4,8,8 --sigma_min 0.002 
--sigma_max 10 --noisemodel_checkpoint /raid/kaifengpang/CM_denoising/save/train_hardi_stage1/model150000.pt --log_interval 500